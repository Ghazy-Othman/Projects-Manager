...
import 'package:projects_manager/controllers/doctor/doctor_login_page_controller.dart';
...
class DoctorLoginScreen extends StatelessWidget {
  ...
  final DoctorLoginPageController controller =
      Get.put(DoctorLoginPageController());
  @override
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          onTap: () {
                            Get.to(() => ForgetPasswordScreen(role: 'doctor',));
                          },
                          child: Text(
                            'Forget Password ? ',
                            style: TextStyle(
